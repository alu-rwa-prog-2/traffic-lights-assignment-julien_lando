// Author: Julien Barezi(main) and Gihozo Landelin
...
public class traffic_lights {
	public static void main(String[] args) {
		...
		ArrayList<Integer> carscollection = new ArrayList<Integer>();
    	...
    	for(int i = 0; i < 15; i++) {
		    ...
		    while (carscollection.contains(newcar));
		...
		for(int i = 0; i < carscollection.size(); i++) {
			try {
			...
			System.out.print("CarModel-" + carscollection.get(i));
		...
		System.out.println("Total cars: " + carscollection.size() + " cars");
		...
		for(int i = 15; i < carscollection.size(); i++) {
			
			int rando = (int) ((Math.random() * carscollection.size()));
			...
			if (counttime % 15 == 0) {
				...
				int removed = carscollection.remove(rando);
		...
		System.out.println("Remaining cars: " + carscollection.size() + " cars");
		...
		for(int i = 25; i < carscollection.size(); i++) {
			
			int grando = (int) ((Math.random() * carscollection.size()));
			...
			if (greentime % 20 == 0) {
				...
				// Removing cars
				int removed;
				do  removed= carscollection.remove(grando);
			    while (carscollection.contains(removed));
		...
		for(int i = 30; i < carscollection.size(); i++) {
		...
		for(int i = 40; i < carscollection.size(); i++) {
		...
		System.out.println("\nIt took: " + TimeTakenInSec8 + " seconds");
		System.out.println("Remaining cars: " + carscollection.size() + " cars");
		
		System.out.println("\n---------------------------------------");
		
		// Printing the summary and then ending the program
		
		System.out.println("\nSummary:");
		System.out.println("\n1)Added Cars: 100 cars");
		System.out.println("2)Remaining cars: 0 cars");
		System.out.println("3)Total time taken: 180 seconds"); 
